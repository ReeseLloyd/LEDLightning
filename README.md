...
| Version | Description |
|---|---|
| **1.4** | Procedural silhouette generators — each object type has a generator function producing unique shapes per seed; objects display dim base colours at all times and brighten during strikes |
